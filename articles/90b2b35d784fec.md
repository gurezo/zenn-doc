...
- メジャーバージョンは、**必ず一つずつ** 上げる
  - ex. Angular v15.x => Angular v16.x
...
![ex. Angular v15.x => Angular v16.x](/images/select.version.png)
_ex. Angular v15.x => Angular v16.x_
...
Angular v15.x => Angular v16.x の場合、アップデート前に実施する作業はありません。
...
### v16 の最新バージョンで、アップデートする場合

```sh
$ ng update @angular/core@v16.x @angular/cli@v16.x
```

### v16 のマイナーバージョンまで指定して、アップデートする場合

```sh
$ ng update @angular/core@v16.3.3 @angular/cli@v16.2.10
```

### Angular CDK, Angular Materail をアップデートする場合

```sh
$ ng update @angular/cdk@v16.x @angular/material@v16.x
```
...
- [v13.x => v14.x ファイル差分](https://github.com/gurezo/ng-migrate-sample/pull/9474/files)
...
- 「–no-save」とするのは、これを指定しないと package.json が作成されてしまいます。
  ...
  $ mkdir test-project
  $ cd test-project
  $ npm i @angular/cli@v16.x --no-save
  ```
