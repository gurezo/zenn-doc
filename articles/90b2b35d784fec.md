...
- ngupdate コマンドで、基本的にアップデートは完了します。
- アップデートがどのような変更があったかを理解したい場合は、[アップデートしたいバージョンで新規プロジェクトを作成して差分を確認する](#アップデートしたいバージョンで新規プロジェクトを作成して差分を確認する) を行って下さい
...
::::details バージョン毎の差分
:::message alert
個々に表示されているバージョン毎の差分はライブラリ調査用のリポジトリを活用しました。
各バージョン毎の PR のファイル差分をご確認下さい。
また調査用のライブラリは、v14.x アップデート後のみ全て更新しました。
あくまでも参考程度で、御覧ください。
:::

- [v11.x+>v12.x ファイル差分](https://github.com/gurezo/ng-migrate-sample/pull/72/)
- [v13.x+>v13.x ファイル差分](https://github.com/gurezo/ng-migrate-sample/pull/73/)
- [v13.x+>v14.x ファイル差分](https://github.com/gurezo/ng-migrate-sample/pull/74/)
- [v14.x 全ライブラリ更新 ファイル差分](https://github.com/gurezo/ng-migrate-sample/pull/75/)
